	...
	<body>
		...
		<div id="show-appUser" class="content scaffold-show" role="main">
			...
			<ol class="property-list appUser">
                ...
                <g:if test="${com.charlesread.AppUserAppRole.findByAppUser(appUserInstance)}">
                    <li class="fieldcontain">
                        <span id="roles-label" class="property-label"><g:message code="appUser.roles.label" default="Roles" /></span>
                        <span class="property-value">
                        <g:each in="${com.charlesread.AppUserAppRole.findAllByAppUser(appUserInstance)}" var="appRoleInstance">
                            ${appRoleInstance.appRole.authority}<br>
                        </g:each>
                        </span>
                    </li>
                </g:if>
