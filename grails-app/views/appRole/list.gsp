...
<%@ page import="com.charlesread.AppRole" %>
<!DOCTYPE html>
<html>
	<head>
			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="authority" title="${message(code: 'appRole.authority.label', default: 'Authority')}" />
				...
				<g:each in="${appRoleInstanceList}" status="i" var="appRoleInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${appRoleInstance.id}">${fieldValue(bean: appRoleInstance, field: "authority")}</g:link></td>
